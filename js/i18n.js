...
const I18N = {
    ...
    da: {
        ...
        'welcomeTour.step.character.text': 'Før spilstart vælger du en fast, fiktiv karakter: et barn, en voksen eller en kraftig voksen. Hver kropsgruppe har faste egenskaber i modellen.\n\nFiguren her viser, hvem du hjælper. Simulatoren bruger ikke dine egne helbredsdata.',
    ...
    en: {
        ...
        'welcomeTour.step.character.text': 'Before the game starts, you choose a fixed fictional character: a child, an adult or a larger adult. Each body group has fixed properties in the model.\n\nThe figure here shows who you are helping. The simulator does not use your personal health data.',
        'welcomeTour.step.insulin.title': 'Insulin',
