...
const I18N = {
    ...
    da: {
        ...
        'food.candy': 'Slik',
        'food.juice': 'Juice',
        'food.latte': 'Caffè latte',
        'food.latte.description': 'Letmælk (1,5 %) og espresso. Uden tilsat sukker.',
        'food.banana': 'Banan',
        ...
        'food.custom.carbType.sugarLiquidTitle': 'Sukker i drikke (fx juice) — passerer pylorus hurtigt, τG ~18 min',
        ...
        'ui.btn.physiology': 'Fysiologi-visning',
        ...
        'mode.campaign.desc': 'Lær gradvist, hvad der påvirker blodsukkeret',
        'mode.screenNote': 'T1D Simulator er designet til at fungere bedst på en større skærm, fx PC eller tablet.',

        // --- Insights og karakterbundet forløbsudforskning ---
        'insights.menu.label': 'Indsigt',
        'insights.menu.title': 'Fysiologi-visning og Hvad Nu Hvis',
        'insights.menu.physiology': 'Fysiologi-visning',
        'insights.menu.physiology.help': 'Se de processer, der påvirker karakterens blodsukker.',
        'insights.menu.explore': 'Hvad Nu Hvis',
        'insights.menu.explore.help': 'Prøv andre handlinger for karakteren.',
        'insights.menu.explore.wait': 'Foretag først en handling i banen.',
        'insights.open.title': 'Hvad Nu Hvis',
        'insights.open.body': 'Banen sættes på pause. Du kan ændre handlinger frem til det sted, banen nåede, og se, hvad der sker.',
        'insights.open.body.box': 'Box Challenge sættes på pause. Du kan ændre handlinger frem til det sted, spillet nåede. Kasserne ligger fast.',
        'insights.open.confirm': 'Sæt på pause og prøv',
        'insights.open.cancel': 'Bliv i banen',
        'insights.open.cancel.box': 'Bliv i Box Challenge',
        'insights.mode': 'Hvad Nu Hvis',
        'insights.return': 'Tilbage til banen',
        'insights.return.title': 'Fortsæt den pausede bane',
        'insights.return.box': 'Tilbage til Box Challenge',
        'insights.return.box.title': 'Fortsæt den pausede Box Challenge',
        'insights.stop.title': 'Luk Hvad Nu Hvis',
        'insights.stop.message': 'Dine ændringer gemmes ikke.',
        'insights.stop.yes': 'Ja, luk',

        // Editorens synlige kontroller i Insights. Fil-, profil- og eksporttekster
        // er ikke med, fordi de funktioner ikke udstilles i den offentlige version.
        'editor.event.meal': 'Måltid',
        'editor.event.bolus': 'Hurtig insulin',
        'editor.event.basal': 'Basal-insulin',
        'editor.event.activity': 'Aktivitet',
        'editor.event.glucagon': 'Glukagon',
        'editor.insulin.rapid': 'Hurtigvirkende',
        'editor.insulin.basal': 'Langtidsvirkende',
        'editor.field.dose': 'Dosis',
        'editor.field.portion': 'Portion',
        'editor.field.duration': 'Varighed',
        'editor.btn.delete': 'Slet',
        'editor.btn.duplicate': 'Dupliker',
        'editor.btn.sweep': 'Variationer',
        'editor.sweep.collapse': 'Luk variationer',
        'editor.sweep.close': 'Luk variationer',
        'editor.sweep.noval': 'Der er intet at afprøve her.',
        'editor.sweep.notime': 'Der er ikke plads til at flytte tidspunktet.',
        'editor.dim.menu': 'Variationer',
        'editor.dim.dose': 'Variér dosis',
        'editor.dim.portion': 'Variér portion',
        'editor.dim.duration': 'Variér varighed',
        'editor.dim.intensity': 'Variér intensitet',
        'editor.dim.time': 'Variér tidspunkt',
        'editor.sweep.shift.planned': 'Spillet',
        'editor.marker.basal': 'Basal',
        'editor.unit.insulin': 'E',
        'editor.death.hypo': 'Lavt blodsukker',
        'editor.death.dka': 'Ketoacidose',
        'editor.death.weight': 'Energiubalance',
        'editor.death.box': 'Ramte en kasse',
        'editor.death.complications': 'Langvarigt højt blodsukker',
        'editor.shorten.confirm': 'Skift til {h} t fjerner {n} hændelse(r) efter {h} t. Fortsæt?',
        'editor.shorten.continue': 'Fortsæt',
        'editor.shorten.cancel': 'Annullér',
        'editor.notice.ok': 'OK',
        'editor.boundary.label': 'Bane spillet hertil',
        'editor.boundary.box.label': 'Bane spillet hertil',
        'editor.boundary.notice': 'Placér handlingen før linjen, hvor banen blev sat på pause.',
        ...
        'campaign.objectives': 'Banens mål',
        ...
        'campaign.replayPrompt': 'Gentag banen, og se, om du kan få flere point.',
        ...
        'campaign.level1.desc': '<p><strong>Prøv</strong><br>{characterName}s sidste basaldosis blev givet kl. 8 i går. Virkningen aftager i løbet af formiddagen. Giv basalinsulin.</p><p><strong>Lær</strong><br>Basalinsulin virker over mange timer. For lidt får typisk blodsukkeret til at stige langsomt gennem dagen. For meget får blodsukkeret til at falde og kan give lavt blodsukker.</p>',
        'campaign.level1.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        ...
        'campaign.level2.desc': '<p><strong>Prøv</strong><br>Læg mærke til, hvad der sker med {characterName}s blodsukker om morgenen. Brug hurtiginsulin til at holde blodsukkeret stabilt, og husk stadig at give basalinsulin.</p><p><strong>Lær</strong><br>Blodsukkeret kan stige om morgenen, selv uden mad. Det kaldes dawn-effekten.</p>',
        'campaign.level2.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        ...
        'campaign.level3.desc': '<p><strong>Prøv</strong><br>Giv {characterName} forskellige snacks og søde drikke. Brug hurtiginsulin til at holde blodsukkeret stabilt.</p><p><strong>Lær</strong><br>Hurtige kulhydrater kan hæve blodsukkeret på kort tid. Søde drikke optages typisk hurtigere end faste snacks.</p>',
        ...
        'campaign.level4_meals.desc': '<p><strong>Prøv</strong><br>Giv {characterName} måltider, og brug hurtiginsulin til at holde blodsukkeret stabilt.</p><p><strong>Lær</strong><br>Blodsukkeret påvirkes af, hvad måltidet indeholder. Protein kan påvirke blodsukkeret senere. Fedt kan forsinke, hvornår sukkeret i maden får blodsukkeret til at stige.</p>',
        'campaign.level4_meals.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        'campaign.level4_meals.obj.eat': 'Sørg for, at {characterName}s energibalance ender over nul',
        ...
        'campaign.level4.desc': '<p><strong>Prøv</strong><br>Giv {characterName} low carb-måltider, og brug hurtiginsulin til at holde blodsukkeret stabilt efter måltiderne.</p><p><strong>Lær</strong><br>Low carb-måltider indeholder få kulhydrater i forhold til protein og fedt. Blodsukkeret kan derfor stige langsomt og længe - måske længere end virkningen af en enkelt dosis hurtiginsulin.</p>',
        'campaign.level4.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        'campaign.level4.obj.eat': 'Sørg for, at {characterName}s energibalance ender over nul',
        'campaign.level4.obj.survive': 'Bevar god blodsukkerkontrol i 3 døgn',

        'campaign.level6_buffet.title': 'Buffet',
        'campaign.level6_buffet.desc': '<p><strong>Prøv</strong><br>Du kan nu frit vælge mellem almindelige måltider, low carb-måltider og snacks - eller lave din egen ret. Sammenlign deres effekt på {characterName}s blodsukker, og prøv også at give noget fed mad før noget sødt.</p><p><strong>Lær</strong><br>Blodsukkerstigningen afhænger af madens sammensætning. Sukkeret i en snack optages langsommere, når der stadig er fed mad i maven, så blodsukkerstigningen bliver mindre stejl. En snack kan også hæve {characterName}s blodsukker, hvis hurtiginsulinen fra et måltid sænker det for meget.</p>',
        'campaign.level6_buffet.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        'campaign.level6_buffet.obj.eat': 'Sørg for, at {characterName}s energibalance ender over nul',

        'campaign.level7.title': 'Hverdagsaktivitet',
        'campaign.level7.desc': '<p><strong>Prøv</strong><br>Vælg hverdagsaktiviteter til {characterName}, og lad {characterName} være aktiv mindst 2 timer hver dag. Husk også, at {characterName} selvfølgelig skal have mad nok gennem dagen.</p><p><strong>Lær</strong><br>Når musklerne arbejder, bruger de mere glukose, og den øgede puls kan få insulin, der allerede er givet, til at blive optaget hurtigere. Alt dette gør, at selv almindelige aktiviteter som at gå, cykle til skole eller støvsuge kan sænke blodsukkeret.</p>',
        'campaign.level7.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        'campaign.level7.obj.eat': 'Sørg for, at {characterName}s energibalance ender over nul',
        ...
        'campaign.level8.desc': '<p><strong>Prøv</strong><br>Lad {characterName} dyrke hård motion mindst 1 time hver dag. Vælg mellem cardio, som løb og cykling, styrketræning, som vægttræning, eller blandet sport, som fodbold og badminton. Husk også, at {characterName} skal have mad nok gennem dagen.</p><p><strong>Lær</strong><br>Forskellige typer motion kan påvirke {characterName}s blodsukker forskelligt. Fælles for dem er, at musklerne bliver mere følsomme over for insulin i tiden efter aktiviteten.</p>',
        'campaign.level8.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        'campaign.level8.obj.eat': 'Sørg for, at {characterName}s energibalance ender over nul',
        ...
        'campaign.level9.desc': '<p><strong>Prøv</strong><br>Hjælp {characterName} igennem en stressende situation på dag 1 og en mild sygdom på dag 2. Se på dag 3, hvordan sygdomseffekten langsomt aftager.</p><p><strong>Lær</strong><br>Stress og sygdom kan begge få leveren til at frigive mere glukose til blodet. Ved sygdom bliver insulin desuden mindre effektiv i modellen, så {characterName} kan have brug for mere insulin for at holde blodsukkeret stabilt i en periode.</p>',
        'campaign.level9.obj.complete': 'Hjælp {characterName} igennem 3 dage',
        'campaign.level9.obj.eat': 'Sørg for, at {characterName}s energibalance ender over nul',
        ...
        'campaign.level10.desc': '<p><strong>Prøv</strong><br>{characterName}s hverdag er fyldt med uventede hændelser. Prøv at hjælpe {characterName} med at håndtere dem, når de opstår. Husk stadig at give {characterName} basalinsulin og mad nok.</p><p><strong>Lær</strong><br>Blodsukkeret påvirkes ofte af flere ting på samme tid. Mad, motion og insulin kan alle bruges til at hjælpe {characterName}, når hverdagen ikke går som planlagt.</p>',
        ...
        'tips.experiment': 'Prøv andre valg, og undersøg, hvordan de ændrer karakterens blodsukker.',
        ...
        'disclaimer.text': 'T1D Simulator er et læringsspil om type 1-diabetes (T1D) og blodsukker. Du hjælper en fast, fiktiv karakter og udforsker, hvordan mad, insulin, aktivitet, søvn og stress påvirker karakterens simulerede blodsukker.<br><br>Spillet bruger ikke dine helbredsdata og giver ikke behandlingsvejledning eller insulindoser til virkelige personer.',
        ...
        'welcomeTour.lead': 'Udforsk blodsukkeret sammen med Oscar og Olivia, Erik og Eva eller Frank og Fiona.',
        'welcomeTour.groupAlt': 'Spillets seks karakterer',
        'welcomeTour.recommended': 'Anbefalet',
        'welcomeTour.choice.tour.title': 'Intro-tour',
        'welcomeTour.choice.tour.copy': 'Se grafen, værktøjerne og spillets knapper på ca. 6 minutter.',
        'welcomeTour.choice.campaign.title': 'Start bane 1',
        'welcomeTour.choice.campaign.copy': 'Lær om basal-insulin ved at spille.',
        'welcomeTour.showOnStartup': 'Vis ved opstart',
        'welcomeTour.notNow': 'Luk velkomst',
        ...
        'welcomeTour.tipDemo.text': 'Spilkarakterens blodsukker er lavt. En hurtig snack kan hæve det.',
        'welcomeTour.tipDemo.link': 'Åbn spilguiden',
        'welcomeTour.step.overview.title': 'Velkommen til T1D Simulator',
        'welcomeTour.step.overview.text': 'T1D Simulator er et læringsspil om type 1-diabetes (T1D) og blodsukker. Du hjælper en fast, fiktiv karakter og udforsker, hvordan mad, insulin, aktivitet, søvn og stress påvirker karakterens simulerede blodsukker.\n\nSpillet bruger ikke dine helbredsdata og giver ikke behandlingsvejledning eller insulindoser til virkelige personer.',
        'welcomeTour.step.graph.title': 'Grafen',
        'welcomeTour.step.graph.text': 'De grønne prikker er spilkarakterens CGM-målinger over tid. Farvebåndene viser, hvor hurtigt du optjener points:\n\n- 2x i bonuszonen\n- 1x i målzonen\n- ½x ved moderat forhøjet blodsukker',
        ...
        'welcomeTour.step.cgm.text': 'Når simulationen kører, vises spilkarakterens aktuelle CGM-værdi her. Pilen viser, om værdien er på vej op, ned eller ligger stabilt. CGM-målingen er forsinket 5-10 minutter i forhold til spilkarakterens faktiske blodsukker.',
        'welcomeTour.step.character.title': 'Karakteren',
        'welcomeTour.step.character.text': 'Før spilstart vælger du en fast, fiktiv karakter: et barn, en voksen eller en kraftig voksen. Kropsgruppen giver karakteren faste egenskaber i simulatoren.\n\nFiguren her viser den valgte karakter. I spillet hjælper du karakteren med at holde et stabilt blodsukker.',
        ...
        'welcomeTour.step.basal.text': 'Basalinsulin dækker spilkarakterens grundbehov over mange timer. Følg blodsukkeret gennem rolige perioder, for eksempel om natten eller flere timer efter mad og hurtiginsulin, og læg mærke til, om det stiger eller falder.\n\nBasal kan gives som én daglig dosis eller fordeles på to doser.',
        ...
        'welcomeTour.step.foodSugars.text': 'Nederste række samler små snacks og drikke. Druesukker og juice kan hæve karakterens blodsukker hurtigt. Chokolade og caffè latte indeholder også fedt, som kan forsinke stigningen.',
        ...
        'welcomeTour.step.timeControls.text': 'Midterknappen sætter spillet på pause og starter det igen. Pilene ændrer tempoet: 1, 4, 12 eller 24 simulerede timer per minut. Brug lavt tempo eller pause, når du skal vælge handlinger. Brug højt tempo, når der ikke sker så meget, for eksempel når spilkarakteren sover.',
        'welcomeTour.step.physiology.title': 'Indsigt',
        'welcomeTour.step.physiology.text': 'Indsigt rummer to mere avancerede værktøjer.\n\nFysiologi-visning\nViser, hvad der sker i modellen.\n\nHvad Nu Hvis\nLader dig ændre de valg, du allerede har foretaget i en bane, og se et andet muligt forløb.',
        'welcomeTour.step.settings.title': 'Settings',
        'welcomeTour.step.settings.text': 'Settings-knappen åbner indstillingerne. Her kan du skifte blodsukkerenhed, slå tips til eller fra og styre lyd, musik og visning.',
        'welcomeTour.step.learn.title': 'Lær mere undervejs',
        'welcomeTour.step.learn.text': 'Mens du spiller, dukker der tips op her. Ikonet til højre for tippet åbner spilguiden på det samme emne. Hjælp-knappen øverst er der også altid.',
        ...
        'm.start.intro': 'Udforsk blodsukkeret sammen med Oscar og Olivia, Erik og Eva eller Frank og Fiona.',
        ...
        'm.insulin.basalLabel': 'Basal', 'm.insulin.fastLabel': 'Hurtig', 'm.insulin.fastHint': 'Bolus dækker måltidernes kulhydrater',
        ...
        'm.disclaimer.title': 'Om simulatoren', 'm.disclaimer.body': 'T1D Simulator er et læringsspil om type 1-diabetes (T1D) og blodsukker. Du hjælper en fast, fiktiv karakter og udforsker, hvordan mad, insulin, aktivitet, søvn og stress påvirker karakterens simulerede blodsukker. Spillet bruger ikke dine helbredsdata og giver ikke behandlingsvejledning eller insulindoser til virkelige personer.', 'm.disclaimer.ok': 'Forstået',
        'm.profile.title': 'Karakter', 'm.profile.intro': 'Ændringer starter forfra med den valgte karakter.',
        'm.settings.display': 'Visning', 'm.settings.fullscreen': 'Fuld skærm', 'm.settings.fullscreen.help': 'Skjul browserens kanter.', 'm.settings.physiology': 'Fysiologi-visning', 'm.settings.physiology.help': 'Vis insulin, kulhydrater, eISF og ketoner på grafen.', 'm.physiology.watermark': 'FYSIOLOGI-VISNING', 'm.settings.showWelcome': 'Velkomstskærm', 'm.settings.showWelcome.help': 'Vis velkomst-skærmen når appen åbnes.', 'm.settings.bgUnit': 'Blodsukkerenhed', 'm.settings.bgUnit.help': 'Skift mellem mmol/L og mg/dL.', 'm.settings.lang': 'Sprog', 'm.settings.lang.help': 'Skift mellem dansk og engelsk.', 'm.settings.sound': 'Lyd', 'm.settings.sfx': 'Lydeffekter', 'm.settings.sfx.help': 'Lyde ved handlinger og hændelser.', 'm.settings.cgm': 'CGM-lyde', 'm.settings.cgm.help': 'Lyd ved nye målinger og advarsler.', 'm.settings.music': 'Musik', 'm.settings.data': 'Data', 'm.settings.clearHs': 'Ryd highscores', 'm.settings.clearHs.help': 'Slet dine gemte rekorder.', 'm.settings.clearHs.confirm': 'Slet alle gemte highscores? Det kan ikke fortrydes.', 'm.settings.clearHs.done': 'Highscores ryddet',
        ...
        'm.menu.campaign': 'Kampagne', 'm.menu.campaign.help': 'Spil banerne, og lær gradvist, hvad der påvirker blodsukkeret.',
    ...
    en: {
        ...
        'food.juice': 'Juice',
        'food.latte': 'Caffè latte',
        'food.latte.description': 'Milk (1.5% fat) and espresso. No added sugar.',
        'food.banana': 'Banana',
        ...
        'food.custom.carbType.sugarLiquidTitle': 'Sugar in drinks (e.g. juice) — passes pylorus quickly, τG ~18 min',
        ...
        // Physiology button (top bar)
        'ui.btn.physiology': 'Physiology view',
        ...
        'mode.campaign.desc': 'Gradually learn what affects blood sugar',
        'mode.screenNote': 'T1D Simulator is designed to work best on a larger screen, such as a PC or tablet.',

        // --- Insights and character-bound course exploration ---
        'insights.menu.label': 'Insights',
        'insights.menu.title': 'Physiology view and What If',
        'insights.menu.physiology': 'Physiology view',
        'insights.menu.physiology.help': 'See the processes affecting the character\'s blood sugar.',
        'insights.menu.explore': 'What If',
        'insights.menu.explore.help': 'Try different actions for the character.',
        'insights.menu.explore.wait': 'Take an action in the level first.',
        'insights.open.title': 'What If',
        'insights.open.body': 'The level will pause. You can change actions up to the point reached in the level and see what happens.',
        'insights.open.body.box': 'Box Challenge will pause. You can change actions up to the point reached in the game. The boxes stay fixed.',
        'insights.open.confirm': 'Pause and try',
        'insights.open.cancel': 'Stay in the level',
        'insights.open.cancel.box': 'Stay in Box Challenge',
        'insights.mode': 'What If',
        'insights.return': 'Back to the level',
        'insights.return.title': 'Continue the paused level',
        'insights.return.box': 'Back to Box Challenge',
        'insights.return.box.title': 'Continue the paused Box Challenge',
        'insights.stop.title': 'Close What If',
        'insights.stop.message': 'Your changes will not be saved.',
        'insights.stop.yes': 'Yes, close',

        // Visible editor controls in Insights. File, profile and export strings are
        // omitted because those functions are not exposed in the public version.
        'editor.event.meal': 'Meal',
        'editor.event.bolus': 'Rapid insulin',
        'editor.event.basal': 'Basal insulin',
        'editor.event.activity': 'Activity',
        'editor.event.glucagon': 'Glucagon',
        'editor.insulin.rapid': 'Rapid-acting',
        'editor.insulin.basal': 'Long-acting',
        'editor.field.dose': 'Dose',
        'editor.field.portion': 'Portion',
        'editor.field.duration': 'Duration',
        'editor.btn.delete': 'Delete',
        'editor.btn.duplicate': 'Duplicate',
        'editor.btn.sweep': 'Variations',
        'editor.sweep.collapse': 'Close variations',
        'editor.sweep.close': 'Close variations',
        'editor.sweep.noval': 'There is nothing to explore here.',
        'editor.sweep.notime': 'There is no room to move this time.',
        'editor.dim.menu': 'Variations',
        'editor.dim.dose': 'Vary dose',
        'editor.dim.portion': 'Vary portion',
        'editor.dim.duration': 'Vary duration',
        'editor.dim.intensity': 'Vary intensity',
        'editor.dim.time': 'Vary time',
        'editor.sweep.shift.planned': 'Played',
        'editor.marker.basal': 'Basal',
        'editor.unit.insulin': 'U',
        'editor.death.hypo': 'Low blood sugar',
        'editor.death.dka': 'Ketoacidosis',
        'editor.death.weight': 'Energy imbalance',
        'editor.death.box': 'Hit a box',
        'editor.death.complications': 'Prolonged high blood sugar',
        'editor.shorten.confirm': 'Switching to {h}h removes {n} event(s) after {h}h. Continue?',
        'editor.shorten.continue': 'Continue',
        'editor.shorten.cancel': 'Cancel',
        'editor.notice.ok': 'OK',
        'editor.boundary.label': 'Level played to here',
        'editor.boundary.box.label': 'Level played to here',
        'editor.boundary.notice': 'Place the action before the line where the level was paused.',
        ...
        'campaign.objectives': 'Level goals',
        ...
        'campaign.replayPrompt': 'Replay the level and see if you can earn more points.',
        ...
        'campaign.level1.title': 'Basal insulin',
        'campaign.level1.desc': '<p><strong>Try</strong><br>{characterName}\'s last basal dose was given at 08:00 yesterday. Its effect fades during the morning. Give basal insulin.</p><p><strong>Learn</strong><br>Basal insulin acts over many hours. Too little usually makes blood sugar rise slowly through the day. Too much makes blood sugar fall and can cause low blood sugar.</p>',
        'campaign.level1.obj.complete': 'Help {characterName} through 3 days',
        ...
        'campaign.level2.desc': '<p><strong>Try</strong><br>Notice what happens to {characterName}\'s blood sugar in the morning. Use rapid insulin to keep blood sugar stable, and remember to keep giving basal insulin.</p><p><strong>Learn</strong><br>Blood sugar can rise in the morning, even without food. This is called the dawn effect.</p>',
        'campaign.level2.obj.complete': 'Help {characterName} through 3 days',
        ...
        'campaign.level3.desc': '<p><strong>Try</strong><br>Give {characterName} different snacks and sweet drinks. Use rapid insulin to keep blood sugar stable.</p><p><strong>Learn</strong><br>Fast carbohydrates can raise blood sugar quickly. Sweet drinks are typically absorbed faster than solid snacks.</p>',
        ...
        'campaign.level4_meals.desc': '<p><strong>Try</strong><br>Give {characterName} meals and use rapid insulin to keep blood sugar stable.</p><p><strong>Learn</strong><br>Blood sugar is affected by what a meal contains. Protein can affect blood sugar later. Fat can delay the rise in blood sugar caused by sugar in the meal.</p>',
        'campaign.level4_meals.obj.complete': 'Help {characterName} through 3 days',
        'campaign.level4_meals.obj.eat': 'Keep {characterName}\'s energy balance above zero',
        ...
        'campaign.level4.title': 'Low carb',
        'campaign.level4.desc': '<p><strong>Try</strong><br>Give {characterName} low-carb meals and use rapid insulin to keep blood sugar stable after meals.</p><p><strong>Learn</strong><br>Low-carb meals contain few carbohydrates compared with protein and fat. Blood sugar can therefore rise slowly and for a long time - perhaps longer than one dose of rapid insulin lasts.</p>',
        'campaign.level4.obj.complete': 'Help {characterName} through 3 days',
        'campaign.level4.obj.eat': 'Keep {characterName}\'s energy balance above zero',
        'campaign.level4.obj.survive': 'Maintain good blood sugar control for 3 days',

        'campaign.level6_buffet.title': 'Buffet',
        'campaign.level6_buffet.desc': '<p><strong>Try</strong><br>You can now freely choose between regular meals, low-carb meals and snacks - or make your own dish. Compare how they affect {characterName}\'s blood sugar, and also try giving fatty food before something sweet.</p><p><strong>Learn</strong><br>The rise in blood sugar depends on what food contains. Sugar in a snack is absorbed more slowly when fatty food is still in the stomach, making the rise less steep. A snack can also raise {characterName}\'s blood sugar if rapid insulin from a meal lowers it too much.</p>',
        'campaign.level6_buffet.obj.complete': 'Help {characterName} through 3 days',
        'campaign.level6_buffet.obj.eat': 'Keep {characterName}\'s energy balance above zero',

        'campaign.level7.title': 'Everyday activity',
        'campaign.level7.desc': '<p><strong>Try</strong><br>Choose everyday activities for {characterName}, and keep {characterName} active for at least 2 hours each day. Remember that {characterName} also needs enough food through the day.</p><p><strong>Learn</strong><br>When muscles work, they use more glucose, and a higher pulse can make insulin that has already been given absorb faster. Together, this means even everyday activities such as walking, cycling to school, or vacuuming can lower blood sugar.</p>',
        'campaign.level7.obj.complete': 'Help {characterName} through 3 days',
        'campaign.level7.obj.eat': 'Keep {characterName}\'s energy balance above zero',
        ...
        'campaign.level8.title': 'Sport',
        'campaign.level8.desc': '<p><strong>Try</strong><br>Let {characterName} do at least 1 hour of hard exercise each day. Choose between cardio, such as running and cycling, strength training, such as weight training, or mixed sport, such as football and badminton. Remember that {characterName} also needs enough food through the day.</p><p><strong>Learn</strong><br>Different types of exercise can affect {characterName}\'s blood sugar differently. What they share is that muscles become more sensitive to insulin in the time after activity.</p>',
        'campaign.level8.obj.complete': 'Help {characterName} through 3 days',
        'campaign.level8.obj.eat': 'Keep {characterName}\'s energy balance above zero',
        ...
        'campaign.level9.desc': '<p><strong>Try</strong><br>Help {characterName} through a stressful situation on day 1 and a mild illness on day 2. On day 3, see how the illness effect gradually fades.</p><p><strong>Learn</strong><br>Stress and illness can both make the liver release more glucose into the blood. During illness, insulin is also less effective in the model, so {characterName} may need more insulin to keep blood sugar stable for a while.</p>',
        'campaign.level9.obj.complete': 'Help {characterName} through 3 days',
        'campaign.level9.obj.eat': 'Keep {characterName}\'s energy balance above zero',
        ...
        'campaign.level10.desc': '<p><strong>Try</strong><br>{characterName}\'s everyday life is full of unexpected events. Try to help {characterName} handle them as they happen. Remember to keep giving {characterName} basal insulin and enough food.</p><p><strong>Learn</strong><br>Blood sugar is often affected by several things at once. Food, exercise and insulin can all be used to help {characterName} when everyday life does not go as planned.</p>',
        ...
        'tips.experiment': 'Try other choices and explore how they change the character\'s blood sugar.',
        ...
        'disclaimer.text': 'T1D Simulator is a learning game about type 1 diabetes (T1D) and blood sugar. You help a fixed, fictional character and explore how food, insulin, activity, sleep and stress affect the character\'s simulated blood sugar.<br><br>The game does not use your health data and does not provide treatment guidance or insulin doses for real people.',
        'disclaimer.accept': 'Got it',

        // --- Welcome and guided tour ---
        'welcomeTour.aria.welcome': 'Welcome popup',
        'welcomeTour.title': 'Welcome to T1D Simulator',
        'welcomeTour.lead': 'Explore blood sugar with Oscar and Olivia, Erik and Eva, or Frank and Fiona.',
        'welcomeTour.groupAlt': 'The game\'s six characters',
        'welcomeTour.recommended': 'Recommended',
        'welcomeTour.choice.tour.title': 'Intro tour',
        'welcomeTour.choice.tour.copy': 'See the graph, tools and game controls in about 6 minutes.',
        'welcomeTour.choice.campaign.title': 'Start level 1',
        'welcomeTour.choice.campaign.copy': 'Learn about basal insulin by playing.',
        'welcomeTour.showOnStartup': 'Show at startup',
        'welcomeTour.notNow': 'Close welcome',
        'welcomeTour.group.navigation': 'Navigation',
        ...
        'welcomeTour.tipDemo.text': 'The game character\'s blood sugar is low. A quick snack can raise it.',
        'welcomeTour.tipDemo.link': 'Open the game guide',
        'welcomeTour.step.overview.title': 'Welcome to T1D Simulator',
        'welcomeTour.step.overview.text': 'T1D Simulator is a learning game about type 1 diabetes (T1D) and blood sugar. You help a fixed, fictional character and explore how food, insulin, activity, sleep and stress affect the character\'s simulated blood sugar.\n\nThe game does not use your health data and does not provide treatment guidance or insulin doses for real people.',
        'welcomeTour.step.graph.title': 'The graph',
        'welcomeTour.step.graph.text': 'The green dots are the game character\'s CGM readings over time. The colored bands show how fast you earn points:\n\n- 2x in the bonus zone\n- 1x in the target range\n- ½x for moderately elevated blood sugar',
        ...
        'welcomeTour.step.cgm.text': 'When the simulation is running, the game character\'s current CGM value is shown here. The arrow shows whether the value is rising, falling, or steady. The CGM reading is delayed 5-10 minutes compared with the game character\'s actual blood glucose.',
        'welcomeTour.step.character.title': 'The character',
        'welcomeTour.step.character.text': 'Before the game starts, you choose a fixed fictional character: a child, an adult or a larger adult. The body group gives the character fixed properties in the simulator.\n\nThe figure here shows the selected character. In the game, you help the character keep their blood glucose stable.',
        'welcomeTour.step.insulin.title': 'Insulin',
        ...
        'welcomeTour.step.basal.title': 'Basal insulin',
        'welcomeTour.step.basal.text': 'Basal insulin covers the game character\'s basic insulin need over many hours. Follow the blood glucose through quiet periods, such as overnight or several hours after food and rapid insulin, and notice whether it rises or falls.\n\nBasal can be given as one daily dose or split into two doses.',
        ...
        'welcomeTour.step.foodSugars.text': 'The bottom row contains small snacks and drinks. Dextrose and juice can raise the character’s blood sugar quickly. Chocolate and caffè latte also contain fat, which can delay the rise.',
        ...
        'welcomeTour.step.kit.title': 'T1D Kit',
        'welcomeTour.step.kit.text': 'A fingerprick shows the game character\'s current blood glucose without CGM delay.\n\nA ketone test measures ketones. Ketones can rise when the body lacks insulin and breaks down fat instead.\n\nDextrose raises blood glucose quickly. Glucagon can be used for severe hypoglycemia in the game.',
        ...
        'welcomeTour.step.timeControls.text': 'The middle button pauses the game and starts it again. The arrows change the pace: 1, 4, 12 or 24 simulated hours per minute. Use a slow pace or pause when choosing actions. Use a high pace when not much is happening, for example when the game character is sleeping.',
        'welcomeTour.step.physiology.title': 'Insights',
        'welcomeTour.step.physiology.text': 'Insights contains two more advanced tools.\n\nPhysiology view\nShows what is happening in the model.\n\nWhat If\nLets you change choices you have already made in a level and see another possible course.',
        'welcomeTour.step.settings.title': 'Settings',
        'welcomeTour.step.settings.text': 'The Settings button opens the app controls. Here you can change the blood sugar unit, turn tips on or off, and control sound, music and display options.',
        'welcomeTour.step.learn.title': 'Learn as you go',
        'welcomeTour.step.learn.text': 'While you play, tips appear here. The icon to the right of a tip opens the game guide on the same topic. The Help button at the top is always there too.',
        ...
        'm.start.intro': 'Explore blood sugar with Oscar and Olivia, Erik and Eva, or Frank and Fiona.',
        ...
        'm.insulin.basalLabel': 'Basal', 'm.insulin.fastLabel': 'Rapid', 'm.insulin.fastHint': 'Bolus covers meal carbohydrates',
        ...
        'm.disclaimer.title': 'About the simulator', 'm.disclaimer.body': 'T1D Simulator is a learning game about type 1 diabetes (T1D) and blood sugar. You help a fixed, fictional character and explore how food, insulin, activity, sleep and stress affect the character\'s simulated blood sugar. The game does not use your health data and does not provide treatment guidance or insulin doses for real people.', 'm.disclaimer.ok': 'Got it',
        'm.profile.title': 'Character', 'm.profile.intro': 'Changes start over with the chosen character.',
        'm.settings.display': 'Display', 'm.settings.fullscreen': 'Fullscreen', 'm.settings.fullscreen.help': 'Hide the browser edges.', 'm.settings.physiology': 'Physiology view', 'm.settings.physiology.help': 'Show insulin, carbs, eISF and ketones on the graph.', 'm.physiology.watermark': 'PHYSIOLOGY VIEW', 'm.settings.showWelcome': 'Welcome screen', 'm.settings.showWelcome.help': 'Show the welcome screen when the app opens.', 'm.settings.bgUnit': 'Blood glucose unit', 'm.settings.bgUnit.help': 'Switch between mmol/L and mg/dL.', 'm.settings.lang': 'Language', 'm.settings.lang.help': 'Switch between Danish and English.', 'm.settings.sound': 'Sound', 'm.settings.sfx': 'Sound effects', 'm.settings.sfx.help': 'Sounds for actions and events.', 'm.settings.cgm': 'CGM sounds', 'm.settings.data': 'Data', 'm.settings.clearHs': 'Clear highscores', 'm.settings.clearHs.help': 'Delete your saved records.', 'm.settings.clearHs.confirm': 'Delete all saved highscores? This cannot be undone.', 'm.settings.clearHs.done': 'Highscores cleared',
        ...
        'm.menu.campaign': 'Campaign', 'm.menu.campaign.help': 'Play the levels and gradually learn what affects blood sugar.',
