...
# ============================================================================
$tourLinesDa = @(
    @{ file = "00-overview.mp3"; text = "Velkommen til T1D Simulator. Det er et læringsspil om blodsukker. Du hjælper fiktive karakterer og ser, hvordan mad, insulin, aktivitet, søvn og stress påvirker deres blodsukker. Prøv forskellige valg, se hvad der sker, og prøv igen." },
    ...
    @{ file = "02-cgm.mp3"; text = "Blodsukker-tallet. Når simulationen kører, vises karakterens aktuelle blodsukker her. Pilen viser om værdien er på vej op, ned, eller ligger stabilt. Målingen er forsinket fem til ti minutter i forhold til modellens blodglukose. Forsinkelsen ses tydeligst ved hurtige fald. I O B betyder insulin on board: hurtiginsulin fra tidligere doser, som stadig har virkning tilbage." },
    @{ file = "04b-profilebutton.mp3"; text = "Profil-knappen. Profil-knappen øverst åbner din spillerprofil." },
    @{ file = "03-profile.mp3"; text = "Spillerprofil. Du kan skrive et spillernavn her. Navnet bruges på highscore-listen." },
    @{ file = "04-insulin.mp3"; text = "Insulin. Insulin-ikonet nederst åbner insulinpanelet. Det er her du giver basal og hurtig insulin." },
    @{ file = "05-basal.mp3"; text = "Basal-insulin. Basal-insulin virker langsomt over mange timer. I spillet kan du undersøge dosen ved at følge karakterens blodsukker gennem rolige perioder, for eksempel om natten eller flere timer efter mad og hurtiginsulin. Basal kan gives som én daglig dosis eller fordeles på to doser." },
    ...
    @{ file = "11b-kitoverview.mp3"; text = "T1D Kit-ikonet nederst åbner dit kit. Tryk på det for at få fat i måleudstyr og nødhjælp." },
    @{ file = "11-kit.mp3"; text = "T1D kit. Fingerprik måler blodsukker direkte i blodet. Brug den til at dobbelttjekke C G M, for eksempel når tallet ikke passer med hvordan du har det. Keton-stik måler ketoner. Ketoner dannes når kroppen mangler insulin og brænder fedt i stedet. Test ved mistanke om insulinmangel, for eksempel glemt basal eller vedvarende højt blodsukker. Druesukker er ren glukose der virker på få minutter, brug det til at korrigere lavt blodsukker. Glukagon er nødhjælp ved svær hypo." },
    @{ file = "12b-timecontrols.mp3"; text = "Tidskontrol. Midterknappen sætter spillet på pause og starter det igen. Pilene ændrer tempoet: 1, 4, 12 eller 24 simulerede timer per minut. Brug lavt tempo eller pause, når du skal vælge handlinger eller tænke dig om. Brug højt tempo, når der ikke sker så meget, for eksempel når du sover." },
    @{ file = "13-physiology.mp3"; text = "Fysiologi-knappen slår ekstra grafer og information til. De hjælper dig med at se og lære, hvad der sker inde i kroppen, og hvilke fænomener der får blodsukkeret til at stige eller falde. Du kan blandt andet følge aktuel insulinvirkning, kulhydratoptag, og hvordan kroppens følsomhed for insulin ændrer sig. Highscores gemmes ikke, mens fysiologi-visningen er slået til." },
    ...
    @{ file = "14-learn.mp3"; text = "Mens du spiller, dukker der tips op med små råd. Under hvert tip sidder et lille ikon. Tryk på det for at åbne spilguiden på lige det emne. Hjælp-knappen øverst er der også altid." },
...
# ============================================================================
$tourLinesEn = @(
    @{ file = "00-overview.mp3"; text = "Welcome to T1D Simulator. It is a learning game about blood glucose. You help fictional characters and see how food, insulin, activity, sleep, and stress affect their blood glucose. Try different choices, see what happens, and try again." },
    ...
    @{ file = "02-cgm.mp3"; text = "The blood glucose number. When the simulation is running, the character's current blood glucose is shown here. The arrow shows whether the value is rising, falling, or steady. The reading is delayed five to ten minutes compared with the model's blood glucose. The delay is most visible during fast drops. I O B means insulin on board: rapid insulin from earlier doses that still has effect left." },
    @{ file = "04b-profilebutton.mp3"; text = "The Profile button. The Profile button at the top opens your player profile." },
    @{ file = "03-profile.mp3"; text = "Player profile. You can enter a player name here. The name is used on the high score list." },
    @{ file = "04-insulin.mp3"; text = "Insulin. The insulin icon at the bottom opens the insulin panel. This is where you give basal and rapid insulin." },
    @{ file = "05-basal.mp3"; text = "Basal insulin. Basal insulin acts slowly over many hours. In the game, you can explore the dose by following the character's blood glucose through quiet periods, such as overnight or several hours after food and rapid insulin. Basal can be given as one daily dose or split into two doses." },
    ...
    @{ file = "11b-kitoverview.mp3"; text = "T one D Kit. The T one D Kit icon at the bottom opens your kit. Tap it to reach your measuring tools and emergency aids." },
    @{ file = "11-kit.mp3"; text = "T one D kit. Fingerprick measures blood sugar directly from blood. Use it to double check the sensor, for example when the reading does not match how you feel. Ketone test measures ketones. Ketones form when the body lacks insulin and burns fat instead. Test when you suspect insulin deficiency, for example a missed basal dose or persistently high blood sugar. Dextrose is pure glucose that works within minutes, use it to correct low blood sugar. Glucagon is emergency help for severe hypos." },
    @{ file = "12b-timecontrols.mp3"; text = "Time controls. The middle button pauses the game and starts it again. The arrows change the pace: 1, 4, 12 or 24 simulated hours per minute. Use a slow pace or pause when you need to choose actions or think. Use a high pace when not much is happening, for example when you are sleeping." },
    @{ file = "13-physiology.mp3"; text = "Physiology mode. The Physiology button shows the hidden mechanisms that affect blood sugar: insulin, carb absorption, effective I S F, and blood sugar forces. This is a great way to learn about the physiology behind blood sugar, but highscores are not saved while it is on." },
    ...
    @{ file = "14-learn.mp3"; text = "While you play, tips appear with short observations. Under each tip there is a small icon. Tap it to open the game guide on that exact topic. The Help button at the top is always there too." },
