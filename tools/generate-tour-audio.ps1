...
$tourLinesDa = @(
    ...
    @{ file = "08-food-sugars.mp3"; text = "Hurtige kulhydrater. Nederste række samler små snacks og drikke. Druesukker og juice kan hæve karakterens blodsukker hurtigt. Chokolade og caffè latte indeholder også fedt, som kan forsinke stigningen." },
    ...
    @{ file = "11-kit.mp3"; text = "Fingerprik viser spilkarakterens aktuelle blodsukker uden C G M-forsinkelse. Keton-stik måler ketoner. Ketoner kan stige, når kroppen mangler insulin og i stedet nedbryder fedt. Druesukker hæver blodsukkeret hurtigt. Glukagon kan bruges ved svær hypo i spillet." },
    ...
    @{ file = "13b-settings.mp3"; text = "Settings-knappen åbner indstillingerne. Her kan du skifte blodsukkerenhed, slå tips til eller fra og styre lyd, musik og visning." },
...
$tourLinesEn = @(
    ...
    @{ file = "08-food-sugars.mp3"; text = "Fast carbs. The bottom row contains small snacks and drinks. Dextrose and juice can raise the character's blood sugar quickly. Chocolate and caffè latte also contain fat, which can delay the rise." },
    ...
    @{ file = "11-kit.mp3"; text = "A fingerprick shows the game character's current blood glucose without C G M delay. A ketone test measures ketones. Ketones can rise when the body lacks insulin and breaks down fat instead. Dextrose raises blood glucose quickly. Glucagon can be used for severe hypoglycemia in the game." },
    ...
    @{ file = "13b-settings.mp3"; text = "The Settings button opens the app controls. Here you can change the blood sugar unit, turn tips on or off, and control sound, music and display options." },
